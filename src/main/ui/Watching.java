...
// Button for the watching list
public class Watching extends JPanel {
    AnimeList wl;
    ...
    public Watching(AnimeList list) {
        super(new BorderLayout());

        wl = list;
        tableModel = new DefaultTableModel(col, 0);
        for (AnimeEntry next: wl.getEntries()) {
    ...
    class RemoveListener implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            tableModel.removeRow(wl.getEntries().indexOf(wl.getEntry(name)));
            wl.removeEntry(name);
    ...
    class AddListener implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            wl.addEntry(new AnimeEntry(name, AnimeEntry.Status.Watching, notes));
    ...
    public static void createAndShowGUI(AnimeList list) {
        ...
        JFrame frame = new JFrame("Watching List");
        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);

        //Create and set up the content pane.
        JComponent newContentPane = new Watching(list);
