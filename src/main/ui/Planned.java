...
// Button for the planned list
public class Planned extends JPanel {
    AnimeList pl;
    ...
    // constructor for planned list
    public Planned(AnimeList list) {
        super(new BorderLayout());

        pl = list;
        tableModel = new DefaultTableModel(col, 0);
        for (AnimeEntry next: pl.getEntries()) {
    ...
    class RemoveListener implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            tableModel.removeRow(pl.getEntries().indexOf(pl.getEntry(name)));
            pl.removeEntry(name);
    ...
    class AddListener implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            pl.addEntry(new AnimeEntry(name, AnimeEntry.Status.Planned, notes));
    ...
    public static void createAndShowGUI(AnimeList list) {
        ...
        JFrame frame = new JFrame("Planned List");
        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);

        //Create and set up the content pane.
        JComponent newContentPane = new Planned(list);
